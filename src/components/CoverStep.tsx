  ...
  return <motion.div initial={{
    ...
    ease: [0.22, 1, 0.36, 1]
      ...
      duration: 0.8
        ...
        <button onClick={onNext} className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-rose text-white rounded-full font-serif text-xl overflow-hidden transition-transform hover:scale-105 active:scale-95 shadow-soft">
